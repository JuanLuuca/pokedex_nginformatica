        ...
        <div className="">
            ...
            <div className="mt-11 mb-4">
                <div className="flex justify-center items-center">
                    ...
                    <input onChange={(e) => setSearch(e.target.value)} type="search" id="default-search" className="block w-96 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Procure um Pokémon" required />
                    {favoritePokemon.length != 0 ?
                        <button className="h-12 w-36 rounded-md bg-yellow-400 ml-4 text-white text-sm ease-in duration-300 hover:bg-yellow-500" onClick={FavoriteApi}>Favoritar Pokémons</button>
                    : null}
